...
def start_iwx_only_chat(local_model_id=constants.DEFAULT_MODEL_NAME,
    ...
    local_api_vector_store = list()
    for prefix in api_index_name_prefix:
        local_api_vector_store.append(vectorstore.get_vector_store(index_base_path=index_base_path,
    ...
    def chatbot(choice_selected, message):
        ...
        if llm is not None:
            ...
            if choice_selected == "API":
                for api_vector_store in local_api_vector_store:
